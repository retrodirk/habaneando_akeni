<div class="fixed bottom-6 right-6">
    <div class="relative group">
        <div
            class="w-12 h-12 bg-red-500 cursor:pointer rounded-full shadow-lg flex items-center justify-center cursor-pointer hover:bg-red-600 transition-colors duration-300">
